...
if($rows==0){
	...
	echo'<p class="alert alert-warning lead text-center">No Classifieds Exist In This category  </p>';
}elseif($rows>0){
$query="select count(*) from classify ";
...
$query="select title ,post_date,classify_id from classify order by post_date desc  LIMIT $offset, $rowsperpage ";
$result=mysqli_query($dbc,$query);
